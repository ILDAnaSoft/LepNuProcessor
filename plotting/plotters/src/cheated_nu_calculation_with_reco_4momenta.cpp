...
void CheatedNuCalculationReco4MomentaPlotter::define_plots(){
	...
	add_new_TH2D("nu_E_Bparents_only", new TH2D("nu_E_Bparents_only", "#nu calculation from MC info + reco 4momenta, only B parents; E_{#nu}^{MC} [GeV]; E_{#nu}^{calc} [GeV]; #nu's", 110, 0, 110, 110, 0, 110) );
